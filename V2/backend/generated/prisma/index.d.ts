...
export namespace Prisma {
  ...
  */
  ...
  export type WeatherOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "date" | "temperature" | "windspeed" | "humidity" | "pressure" | "rainfall", ExtArgs["result"]["weather"]>
  ...
  interface WeatherFieldRefs {
    ...
    readonly pressure: FieldRef<"Weather", 'Float'>
  ...
  export type WeatherWhereInput = {
    ...
    pressure?: FloatFilter<"Weather"> | number
  ...
  export type WeatherScalarWhereWithAggregatesInput = {
    ...
    pressure?: FloatWithAggregatesFilter<"Weather"> | number
